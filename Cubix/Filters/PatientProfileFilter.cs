...
namespace Cubix.Filters
{
    ...
    /// </summary>
    public class PatientProfileTokenFilter : IActionFilter
    {
        ...
        ///// Constructor
        ///// </summary>
        public PatientProfileTokenFilter(IDistributedCache distributedCache)
        {
        ...
        public void OnActionExecuting(ActionExecutingContext context)
        {
            if (context.HttpContext.Request.Headers.ContainsKey("Authorization"))
            {
                ...
                TokenCacheModel oTokenCacheModel = Cache.GetToken(_distributedCache, Constants.TOKEN_PREFIX_PATIENT_PROFILE_USER + LoginId);
                ...
                else if (oTokenCacheModel.UserTypeId != Constants.PATIENT_PROFILE_USER || oTokenCacheModel.Token != token)// If token not matched with current User
                {
                    ErrorModel oResultModel = new ErrorModel(Constants.INSUFFIECIENT_PRIVILEDGE, Constants.INSUFFIECIENT_PRIVILEDGE_MESSAGE);
                    context.Result = new JsonResult(oResultModel);
                }
