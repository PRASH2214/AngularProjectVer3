...
namespace Cubix.Controllers.Patient
{
    ...
    {
        private readonly IPatientProfile _srv;
        ...
        /// </summary>
        public PatientProfileController(IPatientProfile user, IWebHostEnvironment hostingEnvironment, IDistributedCache distributedCache)
        {
        ...
        {
            return await _srv.GetPatient(Me);
        }
        /// <summary>
        ...
        public async Task<ResultModel<object>> UpdateProfile(PatientReg oPatientReg)
        {
            return await _srv.UpdatePatient(oPatientReg, Me);
        }
        ...
        public async Task<ResultModel<object>> UpdateProfileImage(FileUpload oFileUpload)
        {
            ...
            oResultModel = FileUpload(Me.LoginId, oFileUpload.ImagePath, oFileUpload.FileName, oFileUpload.FileFlag, "Patient/Profile", _hostingEnvironment);
